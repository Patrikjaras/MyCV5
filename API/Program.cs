...
app.MapPut("/about", async (string id, About UpdatedObject) =>
{
	try
	{
...
app.MapPut("/contact", async (string id, Contact UpdatedObject) =>
{
	try
	{
...
app.MapPut("/skills", async (string id, Skills UpdatedObject) =>
{
	try
	{
...
app.MapPut("/workexperience", async (string id, WorkExperience UpdatedObject) =>
{
	try
	{
...
app.MapPut("/qualifications", async (string id, Qualifications UpdatedObject) =>
{
	try
	{
...
app.MapPut("/education", async (string id, Education UpdatedObject) =>
{
	try
	{
